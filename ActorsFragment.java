 ...
 */
public class ActorsFragment extends Fragment implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        actorList = db.actorsDao().getActors();

        recyclerView.setLayoutManager(new LinearLayoutManager(recyclerView.getContext()));
        adapter = new ActorsAdapter(actorList, recyclerView.getContext());
    ...
    public boolean onQueryTextChange(String newText) {
        ...
        actorList = db.actorsDao().getActorsByName("%" + newText + "%");
