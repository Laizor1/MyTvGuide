 ...
 */
public class ShowsFragment extends Fragment implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        showList = db.showsDao().getShowsOrderedByName();
    ...
    public boolean onQueryTextChange(String newText) {
        ...
        showList = db.showsDao().findShows("%" + newText + "%");
        recyclerView.setLayoutManager(new LinearLayoutManager(recyclerView.getContext()));
        adapter = new ShowsAdapter(showList, recyclerView.getContext());
        recyclerView.setAdapter(adapter);
        return false;
